        ...
        >
          ...
          >
            {workshopServices.map((service) => (
              <WorkshopServiceRow key={service.href} service={service} />
            ))}
          </nav>
        </div>
        ...
        >
          ...
          >
            ...
            <div>
              ...
              <p
                ...
                "
              >
                Send photographs first so our team can understand the condition
                before your visit.
              </p>
            </div>
          </div>
          ...
          <div className="mt-4">
            <ClayButton
              ...
              showArrow
              className="max-sm:w-full"
              ariaLabel="Send photographs and details of your sofa"
            >
